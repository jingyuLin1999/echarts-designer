<template>
  <div class="cool-navigation-3" :ref="ref" :style="injectStyles">
    <svg
      :width="width"
      :height="height"
      v-for="type in ['svg-bg', 'svg-bg-reverse']"
      :key="type"
      :class="type"
    >
      <!-- 左侧顶部 -->
      ...
      <polygon
        ...
        fill="url(#linear)"
        :points="`${halfWidth * 0.00106},${height * 0.01613}
      ...
      <polygon
        style="stroke-width: 1"
        fill="#60F3FA"
        :points="`${halfWidth * 0.05814},${height * 0.01613}
      ...
      <polygon
        style="stroke-width: 1"
        fill="url(#main)"
        :points="`${halfWidth * 0.07188},${height * 0.01613}
      ...
      <polygon />
      <polyline
        style="fill: none; stroke: #33e8ff; stroke-width: 1"
        :points="`${halfWidth * (0.58034 + titleWidthPct)},${height * 0.156}
      ...
      <polygon
        style="stroke-width: 1"
        fill="url(#rect)"
        :points="`${halfWidth * (0.6025 + titleWidthPct)},${height * 0.3548}
      ...
      <polygon
        style="stroke-width: 1"
        fill="url(#rect)"
        :points="`${halfWidth * (0.579 + titleWidthPct)},${height * 0.3548}
      ...
      <polygon
        style="stroke-width: 1"
        fill="url(#rect)"
        :points="`${halfWidth * (0.5578 + titleWidthPct)},${height * 0.3548}
      ...
      <polygon
        style="stroke-width: 1"
        fill="url(#rect)"
        :points="`${halfWidth * (0.54 + titleWidthPct)},${height * 0.3548}
      ...
      <polyline
        ...
        stroke="url(#rectLine)"
        :points="`${halfWidth * (0.5 + titleWidthPct)},${height * 0.154}
    ...
    <Menu1
      ...
      :style="{ width: halfWidth * (0.5 + titleWidthPct) + 'px' }"
    ></Menu1>
    <Menu1
      class="menu-right"
      :menu="rightMenus"
