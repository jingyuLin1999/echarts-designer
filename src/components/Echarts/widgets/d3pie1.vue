<template>
  <div class="water-eval-container">
    <div class="cityGreenLand-charts" id="cityGreenLand-charts" ref="myChart"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getPie3D(pieData, internalDiameterRatio) {
      ...
      let boxHeight = this.getHeight3D(series, 10); //通过传参设定3d饼/环的高度，26代表26px
    ...
    bindListen(myChart) {
      ...
      myChart.on("click", function (params) {
        ...
        let isSelected = !that.option.series[params.seriesIndex].pieStatus
          .selected;
        let isHovered =
        ...
        if (selectedIndex !== "" && selectedIndex !== params.seriesIndex) {
          that.option.series[
            selectedIndex
          ].parametricEquation = that.getParametricEquation(
