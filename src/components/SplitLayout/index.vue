...
<template>
  ...
  >
    ...
    <!-- 隔离 -->
    <div
      :class="[direction,'first','splitbar',' vbg-2',{expaned:firstIsShow}]"
    ...
    <!-- 隔离 -->
    <div
      :class="[direction,'last','splitbar',' vbg-2',{expaned:lastIsShow}]"
    ...
    <transition name="togglePanel">
      <perfect-scrollbar
        ...
        v-if="hasLastPanel"
        v-show="lastIsShow"
        :style="direction=='hori' ? {width:lastPanelSize}:{height:lastPanelSize}"
      >
        <slot name="last"></slot>
      </perfect-scrollbar>
    </transition>
